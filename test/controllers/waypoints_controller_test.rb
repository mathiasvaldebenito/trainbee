...
class WaypointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waypoint" do
    assert_difference('Waypoint.count') do
      post waypoints_url, params: { waypoint: { latitude: @waypoint.latitude, longitude: @waypoint.longitude } }
    end
  ...
  test "should update waypoint" do
    patch waypoint_url(@waypoint), params: { waypoint: { latitude: @waypoint.latitude, longitude: @waypoint.longitude } }
